...
function MultiplyNumbers({ data, id }) {
  return (
    <div className="text-updater-node">
      <div className="node-header">Multiplicar</div>
...
const MultiplyNumbersNode = {Node: MultiplyNumbers, Exec}

export default MultiplyNumbersNode;
