...
function Rectangle({ data, id }) {
  return <GenericInOutNode node_label={localGetCopy("structuralRectangleSection")} data={data} id={id} target_ids={rectangular_target_ids} source_ids={["section_out-id"]}></GenericInOutNode>;
}
